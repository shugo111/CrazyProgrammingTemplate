...
<body>
  ...
  <div class="sidenav">
    <br><br>
  <a href="Dashboard.html" >Leaderboard</a><br>
  <a href="Event.html">Upcoming events</a><br>
  <a href="Addcomp.html" id="hell">Add Competition</a><br>
  <a href="weitage.html" active >Change weightage</a><br>
...
<?php
  ...
  $sql="INSERT into problem(pname,description,constraints,sample_input,sample_output,sample_pgm,e_id) values ('$pname','$description','$constraints','$sample_input','$sample_output','$samplepgm','$e_id')";

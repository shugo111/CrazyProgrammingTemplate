...
$sql="INSERT into `testcase` (`e_id`,`p_id`,`input`) values('$e_id','$p_id','$input')";
...
<body>
  ...
  <a href="weitage.html" active id="hell">Change weightage</a><br>
...
<button type="submit" class="btn btn-primary" formaction="addcomp7.html">Add another test case</button>
            ...
            <br>
            <br>
            <button type="submit" class="btn btn-primary" formaction="addcomp.html">Done</button>
        </form>
        </div>
    </div>
</div>
